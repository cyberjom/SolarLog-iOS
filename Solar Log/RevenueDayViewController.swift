//
//  RevenueDayViewController.swift
//  Solar Log
//
...
class RevenueDayViewController: UIViewController ,CPTBarPlotDataSource,CPTBarPlotDelegate,CPTPlotSpaceDelegate {
